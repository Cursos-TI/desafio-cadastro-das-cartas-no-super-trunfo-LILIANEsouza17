...
int main(){
    ...
    char ESTADOELETRA[] = "ESTADO A,B,C,D,E,F,G,H";
    char CIDADE[] = "CIDADE 1,2,3,4";
    ...
    printf("\n ESTADO:  ");//USUARIO CADASTRA O NOME E A LETRA DO ESTADO DO PAÍS ESCOLHIDO.
    scanf(" %s %c",ESTADOELETRA);
